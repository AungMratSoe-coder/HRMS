...
/** Development-only: captures the Training module screen via real navigation. */
public final class TrainingScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("training"));
        Thread.sleep(1500);

        File out = new File("screenshots/training.png");
