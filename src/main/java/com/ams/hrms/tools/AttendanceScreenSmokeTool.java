...
/** Development-only: captures the Attendance module screen via real navigation. */
public final class AttendanceScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("attendance"));
        Thread.sleep(1500);

        File out = new File("screenshots/attendance.png");
