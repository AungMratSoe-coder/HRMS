...
/** Development-only: captures the Separation module screen via real navigation. */
public final class SeparationScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("separation"));
        Thread.sleep(1500);

        File out = new File("screenshots/separation.png");
