...
/** Development-only: captures the Asset module screen via real navigation. */
public final class AssetScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("assets"));
        Thread.sleep(1500);

        File out = new File("screenshots/assets.png");
