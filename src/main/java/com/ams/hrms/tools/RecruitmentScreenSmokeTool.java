...
/** Development-only: captures the Recruitment module screen via real navigation. */
public final class RecruitmentScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("recruitment"));
        Thread.sleep(1500);

        File out = new File("screenshots/recruitment.png");
