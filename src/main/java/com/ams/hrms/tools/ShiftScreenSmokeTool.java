...
/** Development-only: captures the Shifts module screen via real navigation. */
public final class ShiftScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("shifts"));
        Thread.sleep(1500);

        File out = new File("screenshots/shifts.png");
