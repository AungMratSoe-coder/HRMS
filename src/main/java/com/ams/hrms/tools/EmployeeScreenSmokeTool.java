...
/** Development-only: captures the Employees module screen via real navigation. */
public final class EmployeeScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("employees"));
        Thread.sleep(1500);

        File out = new File("screenshots/employees.png");
