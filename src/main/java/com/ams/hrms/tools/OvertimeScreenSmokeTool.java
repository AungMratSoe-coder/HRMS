...
/** Development-only: captures the Overtime module screen via real navigation. */
public final class OvertimeScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("overtime"));
        Thread.sleep(1500);

        File out = new File("screenshots/overtime.png");
