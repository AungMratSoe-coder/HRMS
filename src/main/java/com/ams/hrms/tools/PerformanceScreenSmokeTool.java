...
/** Development-only: captures the Performance module screen via real navigation. */
public final class PerformanceScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("performance"));
        Thread.sleep(1500);

        File out = new File("screenshots/performance.png");
