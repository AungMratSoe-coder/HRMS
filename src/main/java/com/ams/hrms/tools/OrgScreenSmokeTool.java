...
/**
 * Development-only: captures the Departments module screen (light theme)
 * through the real MainFrame navigation.
 */
public final class OrgScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2000); // dashboard loads first
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("departments"));
        Thread.sleep(1200); // async table load

        File out = new File("screenshots/org-departments.png");
