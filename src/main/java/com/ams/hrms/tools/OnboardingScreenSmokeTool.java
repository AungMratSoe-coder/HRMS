...
/** Development-only: captures the Onboarding module screen via real navigation. */
public final class OnboardingScreenSmokeTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(2200);
        SwingUtilities.invokeAndWait(() -> holder[0].navigation().navigate("onboarding"));
        Thread.sleep(1500);

        File out = new File("screenshots/onboarding.png");
